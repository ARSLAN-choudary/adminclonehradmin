...
export class UploadDocumentsComponent {
  ...
  private transformFormData(formValue: any): any {
    ...
    return {
      ...
      citizenship: personal.citizenship, // ADDED: Include citizenship in payload
  ...
  private createFormData(transformedData: any): FormData {
    ...
    if (documents.doc1?.url) {
      ...
      if (blob.size > 0) {
        formData.append('documents', blob, 'passport.jpg');
    ...
    if (documents.doc2?.url) {
      ...
      if (blob.size > 0) {
        formData.append('documents', blob, 'residenceCard.jpg');
    ...
    if (documents.doc3?.url) {
      ...
      if (blob.size > 0) {
        formData.append('documents', blob, 'healthCard.jpg');
    ...
    if (documents.doc4?.url) {
      ...
      if (blob.size > 0) {
        formData.append('documents', blob, 'drivingLicense.jpg');
