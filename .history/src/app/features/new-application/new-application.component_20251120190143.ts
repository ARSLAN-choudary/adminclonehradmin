  ...
  async generateTraineeContract() {
    ...
    try {
      ...
      this.traineeContract = {
        ...
        fileName: `Trainee_Contract_${this.employeeData.name
          }_${Date.now()}.pdf`,
        data: contractData,
      };
  ...
  async generateProbationContract() {
    ...
    try {
      ...
      this.probationContract = {
        ...
        type: "probation",
        generatedDate: new Date(),
        fileName: `Probation_Contract_${this.employeeData.name
          }_${Date.now()}.pdf`,
        data: contractData,
      };
      ...
      this.backendService.uploadContract(this.probationContract).subscribe((res: any) => {
      })
    } catch (error) {
