...
>>>>>>> 75164df0c13c5b24c11243f7447d2a8b89f91337
    ...
    ngOnInit() {
        ...
        this.getApplicationList(0, this.pageSize);

        this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
            this.pageSize = res.pageSize;

            this.skip = res.skip;
            this.getApplicationList(this.skip, this.pageSize);
        });
    }
    ...
    getApplicationList(skip = 0, limit = this.pageSize): void {
        const req = {
            startDate: "",
            endDate: "",
            draw: 1,
        ...
        this.backendService.getApplications(req).subscribe((apiRes: any) => {
            ...
            this.totalData = apiRes.totalData ?? this.tableData.length;
