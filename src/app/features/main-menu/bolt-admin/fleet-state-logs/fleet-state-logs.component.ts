import {ChangeDetectorRef, Component, ElementRef, Renderer2, signal, ViewChild, WritableSignal} from '@angular/core';
...
import {BoltFleetDataTable, superadmincompanies} from "../../../../shared/model/pages.model";
...
@Component({
    ...
    templateUrl: './fleet-state-logs.component.html',
    styleUrl: './fleet-state-logs.component.scss'
})
export class FleetStateLogsComponent {
    ...
    private getTableData(skip: number, limit: number): void {
        ...
        this.backendService.getBoltFleetStateLogs(payload)
            .pipe(
                tap((apiRes: any) => {
