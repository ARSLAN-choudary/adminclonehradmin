...
import {DatePipe, DecimalPipe, NgClass, NgForOf, NgIf, NgSwitch, NgSwitchCase} from "@angular/common";
import {
    AbstractControl,
    FormBuilder,
    FormGroup,
...
import {companiesDataTable, superadmincompanies} from "../../../../shared/model/pages.model";
...
export class VehiclesComponent {
    ...
    private getTableData(skip: number, limit: number): void {
        ...
        this.backendService.getBoltVehicles(payload).pipe(tap((apiRes: any) => {
