...
export class VehiclesComponent {
  ...
  public tableData: boltDriverDataTable[] = [];
  public serialNumberArray: number[] = [];
  currentEditingImageUrl?: string;
  editPreviewUrl?: string;
  private editPreviewObjectUrl?: string;
  public dataSource!: MatTableDataSource<boltDriverDataTable>;
  ...
  private getTableData(skip: number, limit: number): void {
    ...
    this.backendService
      ...
      .subscribe((apiRes: any) => {
        ...
        this.dataSource = new MatTableDataSource<boltDriverDataTable>(
          this.tableData
        );
